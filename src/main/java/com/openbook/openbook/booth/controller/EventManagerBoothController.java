...
import com.openbook.openbook.booth.service.EventManagerBoothService;
...
public class EventManagerBoothController {

    private final EventManagerBoothService eventManagerBoothService;
    ...
    public ResponseEntity<PageResponse<BoothManageData>> getBoothManagePage(@RequestParam(defaultValue = "all") String status,
        ...
        return ResponseEntity.ok(PageResponse.of(
                eventManagerBoothService.getBoothManageData(status, eventId, pageable, Long.valueOf(authentication.getName()))));
    }
    ...
    public ResponseEntity<ResponseMessage> changeBoothStatus(@PathVariable Long boothId,
        ...
        eventManagerBoothService.changeBoothStatus(boothId, request.boothStatus(), Long.valueOf(authentication.getName()));
